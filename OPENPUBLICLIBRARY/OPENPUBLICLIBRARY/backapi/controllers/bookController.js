...
exports.index = (req, res, next) => {
    async.parallel({
        ...
        res.render('library/index', {title: 'Local Library Home', error: err, data: results});     
    });
};
...
exports.book_list = (req, res, next) => {
    Book.find({}, 'title author')
        ...
        .exec((err, list_books) => {
            ...
            res.render('library/book_list', {title: 'Book List', book_list: list_books});
        });
};
...
exports.book_detail = (req, res, next) => {
    async.parallel({
        ...
        // Successful, so render
        res.render('library/book_detail', {title: 'Title', book: results.book, book_instances: results.book_instance});
    });
};
// 由GET显示创建book的表单
exports.book_create_get = (req, res, next) => {
    ...
    async.parallel({
        ...
        if (err, results) {
            res.render('library/book_form', {title: 'Create Book', authors: results.authors, genres: results.genres});
        }
    });
};
