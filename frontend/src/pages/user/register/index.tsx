            ...
            rules={[
              {
                ...
                message: formatMessage({ id: 'userandregister.address.required' }),
              },
              {
                // pattern: /^\d{11}$/,
                pattern: /^[\s\S]+$/,  //match all unicode
                // message: formatMessage({ id: 'userandregister.phone-number.wrong-format' }),
                message: formatMessage({ id: 'userandregister.address.wrong-format' }),
              },
            ]}
          >
            <Input
              ...
              placeholder={formatMessage({ id: 'userandregister.address.placeholder' })}
            />
          </FormItem>
        </InputGroup>
        {/* <Row gutter={8}>
